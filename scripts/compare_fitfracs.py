...
def compareFitFractions(
    ...
    for reacInfo in reactions:
        ...
        for ampInfo in ampList:
            ...
            nameGenFrac[ampName] = abs(inputProdAmp * inputProdAmp.conjugate()) * abs(ni.ampInt(ampName, ampName))
            ...
            for conjAmpInfo in ampList:
                ...
                inputTotal += inputProdAmp * inputConjProdAmp.conjugate() * ni.ampInt(ampName, conjAmpInfo.fullName())
