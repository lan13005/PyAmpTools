...
def _cli_runFits():
    ...
    parser.add_argument("-s", "--seedfile", type=str, default="seed", help="Output file for seeding next fit based on this fit. Do not include extension")
    ...
    parser.add_argument("-m", "--maxIter", type=int, default=100000, help="Maximum number of fit iterations")
