...
def test_cfg_LoadParameters():
    ...
    true_params = {
        "etapi::imZ::resAmp1": (10 + 0j),
        "etapi::imZ::resAmp2": (10 + 0j),
        "etapi::imZ::resAmp3": (10 + 0j),
        "mass1": 1.0,
        "mass2": 2.0,
        "width2": 200.0,
        "width3": 300.0,
    ...
    true_paramsIsReal = {
        "etapi::imZ::resAmp1": True,
        "etapi::imZ::resAmp2": False,
        "etapi::imZ::resAmp3": False,
        "mass1": True,
        "mass2": True,
        "width2": True,
        "width3": True,
...
def test_result_LoadParameters():
    ...
    true_params = {
        ...
        "mass1": 2.38827351798476,
        "mass2": 2.94879810784617,
        "width2": 5.30501566756126,
        "width3": 0.0,
    }
    true_paramsIsReal = {
        "etapi::imZ::resAmp1": True,
