...
public:
  ...
  /**
   * Provide alternative signature to allow access to the likelihood calculators
  */
  void setupFromConfigurationInfo( const ConfigurationInfo* configInfo,
  ...
  map< string, Neg2LnLikContrib* > getMapNameToNeg2LnLikContribs() const{
    return m_mapNameToNeg2LnLikContribs;
  }
