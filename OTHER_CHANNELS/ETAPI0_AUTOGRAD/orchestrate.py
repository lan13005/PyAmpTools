...
from pyamptools.utility.resultManager import ResultManager, plot_binned_intensities, plot_binned_complex_plane, plot_overview_across_bins
...
random.seed(12322)
nseeds = 5
seeds = random.sample(range(1000000), nseeds)
...
for seed in seeds:
    ...
    with tempfile.NamedTemporaryFile(delete=True) as tmp_main_yaml, \
        ...
        execute_cmd([f"pa run_mcmc {parent_directory}/SEED_{seed}/GENERATED/main.yaml -np 17 -nc 8 -nw 500 -ns 1000"], console=console)
